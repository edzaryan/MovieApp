    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles(GeometryFactory geometryFactory) 
        {
            ...
            CreateMap<MovieCreationDTO, Movie>()
                ...
                .ForMember(x => x.MoviesMovieTheaters, options => options.MapFrom(MapMovieTheatersMovies))
                .ForMember(x => x.MoviesActors, options => options.MapFrom(MapMoviesActors));

            CreateMap<Movie, MovieDTO>()
                .ForMember(x => x.Genres, options => options.MapFrom(MapMoviesGenres))
                .ForMember(x => x.MovieTheaters, options => options.MapFrom(MapMovieTheatersMovies))
                .ForMember(x => x.Actors, option => option.MapFrom(MapMoviesActors));
        ...
        private List<MovieTheaterDTO> MapMovieTheatersMovies(Movie movie, MovieDTO movieDTO)
        {
            ...
            if (movie.MoviesMovieTheaters != null)
            {
                foreach (var movieTheaterMovies in movie.MoviesMovieTheaters)
                {
        ...
        private List<MoviesGenres> MapMoviesGenres(MovieCreationDTO movieCreationDTO, Movie moviedto)
        {
