import {actorCreationDTO} from "../pages/Actor/Actors.model";
...
export function convertMovieToFormData(movie: movieCreationDTO){
    ...
    formData.append('inTheaters', String(movie.inTheatres));
    ...
    formData.append('movieTheatersIds', JSON.stringify(movie.movieTheatresIds));
